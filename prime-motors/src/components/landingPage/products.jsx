...
const Products = () => {
  ...
  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '20px', flexWrap: 'wrap', gap: '20px', marginBottom: '30px'}}>
    <div>
      <img src={dockerIcon} alt="Car 1" width={300} height={300} style={{ display: 'block', margin: 'auto' }} />
    ...
    <div>
      <img src={image4} alt="Car 2" width={250} height={300} style={{ display: 'block', margin: 'auto' }} />
      <div style={{ textAlign: 'center', marginTop: '10px'}}>
    ...
    <div>
      <img src={image3} alt="Car 3" width={250} height={300} style={{ display: 'block', margin: 'auto' }} />
      <div style={{ textAlign: 'center', marginTop: '10px'}}>
    ...
    <div>
      <img src={image2} alt="Car 3" width={300} height={300} style={{ display: 'block', margin: 'auto' }} />
      <div style={{ textAlign: 'center', marginTop: '10px'}}>
    ...
    <div>
      <img src={image5} alt="Car 3" width={250} height={300} style={{ display: 'block', margin: 'auto' }} />
      <div style={{ textAlign: 'center', marginTop: '10px'}}>
